            ...
            <div id="badge-stat-slider-items" class="widget-box-content-slider">
              ...
              <div class="widget-box-content-slider-item">
                ...
                @endif
                  ...
                  <p class="badge-item-stat-text">Level yang dibutuhkan untuk mengklaim minimum level {{$reward->minimum_level}} dan @if($reward->batasan_klaim < 0 )Tanpa Batasan Klaim @else batasan klaim sebanyak {{$reward->batasan_klaim}} kali @endif. @if($reward->id_trigger != "")  Untuk mengklaim anda pastikan anda telah menyelesaikan {{$reward->tipe}} yang berjudul {{$reward->judul_reward}}.@endif</p>
                  <!-- /BADGE ITEM STAT TEXT -->
