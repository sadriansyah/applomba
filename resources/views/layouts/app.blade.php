  ...
  <nav id="navigation-widget-small" class="navigation-widget navigation-widget-desktop closed sidebar left delayed">
    ...
    <a class="user-avatar small no-outline online" >
      ...
      <div class="user-avatar-content">
        ...
        <div class="hexagon-image-30-32" data-src="{{URL::asset('img/avatar/user.jpg')}}"></div>
        @else
...
var tugasup = window.setInterval(updatetugas,10000);
var a = document.getElementById("exp").value;
var batas = 100+({{Auth::user()->level}}*100);
