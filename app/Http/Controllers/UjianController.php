...
class UjianController extends Controller
{
    ...
    function buatujian(Request $req){
      ...
      //     'tipe' => "Ujian",
      //     'jenis' => $req->tipe_ujian,
      //     'judul' => $req->judul_ujian,
      ...
      //   Mail::send('mailnotifujian',$data, function ($mail) use($detail,$notif){
    ...
    function jawabujian(Request $req){
      ...
      // $dataujian = DB::select("SELECT*FROM ujians WHERE id='$idujian'");
      // date_default_timezone_set("Asia/Makassar");
      // $tgltoday = date("l, d-m-Y: h:i:sa");
      //
      // $notif = "Funlearning Today ".$tgltoday;
      ...
      //     foreach($dataujian as $dtujian){
      //
      //       $data = array(
      //         'nama_user' => $dtmember->nama_user,
      //         'nama_mk' => $detail->nama_mk,
      //         'tipe' => "Ujian",
      //         'jenis' => $dtujian->tipe_ujian,
      //         'judul' => $dtujian->judul_ujian,
      //         'tanggalhariini' => $tgltoday,
      //       );
      //     }
      //
      //   }
      //
      //   Mail::send('mailnotifjawabujian',$data, function ($mail) use($detail,$notif){
      //     $mail->to($detail->email, 'no-reply')
      //       ->subject("$notif");
      //     //$mail->from('funlearningitk@gmail.com','Funlearning ITK');
      //   });
