...
class ChallengesController extends Controller
{
    ...
    function editchallenge(Request $req){
      ...
      // $datamemberusers = DB::select("SELECT*FROM members,users WHERE members.nim_nip_user = users.nim_nip AND members.id_kelas ='$challenge->id_kelas'");
      // $datadosenkelas = DB::select("SELECT*FROM kelas,users WHERE kelas.id_dosen = users.nim_nip AND kelas.id ='$challenge->id_kelas' ");
      // $tgltoday = date("l, d-m-Y: h:i:sa");
      // foreach($datadosenkelas as $dtdosen){
      //   $data = array(
      //     'nama_user' => $dtdosen->nama_user,
      //     'nama_mk' => $dtdosen->nama_mk,
      //     'tipe' => "Mengupdate Challenge",
      //     'waktu_mulai' => $req->waktu_mulai,
      //     'waktuselesai' => $req->waktu_selesai,
      //     'judul' => $req->judul_challenge,
      ...
      //   Mail::send('mailnotifchallenge',$data, function ($mail) use($detail,$notif){
    ...
    function jawabchallenge(Request $req){
      ...
      //
      // $datamemberusers = DB::select("SELECT*FROM members,users WHERE members.nim_nip_user = users.nim_nip AND members.id_kelas ='$idkelas' AND members.nim_nip_user='$idusr'");
      // $datadosenkelas = DB::select("SELECT*FROM kelas,users WHERE kelas.id_dosen = users.nim_nip AND kelas.id ='$idkelas' ");
      // $datatugas = DB::select("SELECT*FROM challenges WHERE id='$id'");
      // $tgltoday = date("l, d-m-Y: h:i:sa");
      //
      // $notif = "Funlearning Today ".$tgltoday;
