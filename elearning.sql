...
--
-- Host: localhost
-- Generation Time: Jan 25, 2022 at 12:30 AM
...
--
-- Table structure for table `jawaban_challenges`
--
...
--
-- Dumping data for table `jawaban_challenges`
--
...
--
-- Dumping data for table `jawaban_ujians`
--
...
('1jBZs1LroxtDxV0pPxRnaWfzWCbqXay5OATwyPZF', NULL, '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiZlhqNnowQTFMNzlpOTlkemV3UTJsMkQzeWxwVjhIdVUwRThESW9LYyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjc6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9sb2dpbiI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1643065463),
('JItq78WyEU0RNfqrciZzSWBBkOShJkoyvqx5SfCn', NULL, '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiaUhnNGhUTTBHZUo1ZmYxN1MwMTJlVWo2dW5nYUg1TnIyajdJeXlNRSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjc6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9sb2dpbiI7fX0=', 1643065403),
('qwFXIsLWFzlZHq5aEKyqhYRsbBggSwdfpis79iOy', 9, '127.0.0.1', 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1', '', 1643066999);

-- --------------------------------------------------------

--
-- Table structure for table `transaksi_poins`
--
...
--
-- Dumping data for table `transaksi_poins`
--
...
(9, '10171069', '10171069', 'Siswa 1', 'siswa@gmail.com', 'Mahasiswa', '$2y$10$bYwZEXgvvHrUFnbV2ToCJu0P.HvAb9tLSVYAYfaJDjYd0gP/04nCy', NULL, NULL, 60, 60, 0, 'yRuwfZ9N4KWlZVTf7bptBnS9TyRsgSt1ttEj2QBrU5LwwCEoStn7a63i8mC4', NULL, '2020-11-30 20:01:21', '2020-11-30 20:01:21');
...
--
-- Indexes for table `jawaban_challenges`
--
...
--
-- Indexes for table `transaksi_poins`
--
...
--
-- AUTO_INCREMENT for table `jawaban_challenges`
--
ALTER TABLE `jawaban_challenges`
...
--
-- AUTO_INCREMENT for table `transaksi_poins`
--
ALTER TABLE `transaksi_poins`
